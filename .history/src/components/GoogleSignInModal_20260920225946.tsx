...
import { X, ShieldCheck, AlertCircle, Info, Sparkles, Lock } from 'lucide-react';
              ...
              <div className="rounded-xl border border-amber-200 bg-amber-50/70 p-3 text-xs text-amber-900 leading-relaxed">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5">
                      Add the Google OAuth credentials to your server environment to enable live sign-in.
                    </p>
                  </div>
                </div>
              </div>
