      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="mx-auto max-w-3xl text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-emerald-300 bg-emerald-50 px-3.5 py-1 text-xs font-semibold text-emerald-900 mb-6">
            ...
            <span>Compassionate, private support for everyday emotional wellbeing</span>
          </div>
        ...
        <div className="mt-16 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-2xl border border-stone-200/90 bg-white p-6 shadow-xs">
            ...
            <h2 className="text-lg font-semibold text-stone-900">Warm, Private AI Support</h2>
            <p className="mt-2 text-sm text-stone-600 leading-relaxed">
              Thoughtful voice and text support designed to feel calm, responsive, and respectful
