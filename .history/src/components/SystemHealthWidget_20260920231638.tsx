          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <div className="rounded-xl border border-stone-200 bg-stone-50/70 p-3.5">
              ...
              <div className="mt-1 flex items-center gap-1.5 text-sm font-semibold text-stone-900">
                ...
                <span>{health.features.realtimeVoiceReady ? 'Ready (Live voice)' : 'Awaiting API Key'}</span>
              </div>
              <div className="text-[10px] text-stone-500 mt-1">Voice: private realtime session</div>
            </div>
