...
const signInSource = readFileSync(join(root, 'src/components/GoogleSignInModal.tsx'), 'utf8');
...
assert.doesNotMatch(signInSource, /Phase 2|Test Personas|securityChecklist|Phase 2 Criteria/i);
